...
function Home() {
  ...
  const getRecipies = async () => {
    const response = await axios({
      method: "get",
      url: "https://amazonapi12.herokuapp.com/product",
    });
    ...
    <div>
      ...
      >
        ...
        <SwiperSlide>
          <img
            className="home__image"
            src="https://images-eu.ssl-images-amazon.com/images/G/31/img22/Beauty/GW/May/Unrec/Kotak/Skincare-desktop-Hero._CB637398142_.jpg"
            alt=""
          />
        </SwiperSlide>
        <SwiperSlide>
